...
discovered to be very useful for time scale modification. The algorithm eventually
boils down to a complex approach for creating synthesis frames, but has a more
interesting story for how it was invented.
...
however, send the phase information too. Figure \ref{fig:PVFLowDiagram} shows how
