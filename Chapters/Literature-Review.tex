...
\centering
	...
	{FrameBasedTSM}
	\caption{\footnotemark Frame based approach of many TSM procedures}
	\label{fig:FrameBasedApproach}
\end{figure}

\footnotetext{\url{https://en.wikipedia.org/wiki/Audio_time_stretching_and_pitch_scaling#/media/File:GeneralizedPrinciple_TSM.png}
