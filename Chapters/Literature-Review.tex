...
ratio\cite{Harmony}. For example an octave produces a ratio of 1:2, a perfect 5th
produces a ratio of 3:2. Figure \ref{fig:Harmony} shows how these two harmonies
are seen when their waveforms are plotted. This simple pattern produced by simple
ratio's is the origin of why two notes sound harmonious.
...
of these ratio's and corresponding interval names are given. This tuning method is called
Pythagorean tuning and was used before 1X00's. This was naturally discovered
because it corresponds to the different modes by which a string vibrates when
plucked\cite{StringVibrate}.

Unfortunately this Pythagorean method poses a problem when harpsichords and
