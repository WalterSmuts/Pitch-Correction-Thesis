...
listing \ref{lst:getClosestFreqContour}. The exact details of how the correct
frequencies are calculated will be explained in the ``Choosing Wanted Frequency''
section. Listing \ref{lst:getClosestFreqContour} shows how the closest frequency
...
reasonably good approximation for the actual frequency contour.
