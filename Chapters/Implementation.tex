...
segment as shown in listing \ref{lst:getFrequencyContour}. This is the main
algorithm discussed in the different approaches. The algorithm decides whether the
segment is voiced or not, and if not, just returns the value of the previous
frequency returned.
